...
if(VCPKG_HOST_IS_MSVC AND NOT VCPKG_DETECTED_MSVC)
...
vcpkg_from_github(
  ...
  "${VERSION}"
  SHA512
  7083b73c3cf763f6f7a7edb70a5171f44d27045a0f5e52ca043e0a86379af2c50cf85dbfea30ebaa22a7bb2929452581d26b1ba18945023b057267d4c3bad2f7
  HEAD_REF
  master)
...
if("test-helpers" IN_LIST FEATURES)
  set(ABSL_TEST_HELPERS_OPTIONS
      "-DABSL_BUILD_TEST_HELPERS=ON" "-DABSL_USE_EXTERNAL_GOOGLETEST=ON"
...
if(VCPKG_TARGET_IS_MINGW)
  # LIBRT-NOTFOUND is needed since the system librt may be found by cmake in a
  # cross-compile setup. See https://github.com/pywinrt/pywinrt/pull/83 for the
  # FIReference definition issue.
  set(ABSL_MINGW_OPTIONS
      "-DLIBRT=LIBRT-NOTFOUND"
...
if(VCPKG_TARGET_IS_IOS OR VCPKG_TARGET_IS_OSX)
  file(APPEND "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/absl_time.pc"
       "Libs.private: -framework CoreFoundation\n")
  if(NOT VCPKG_BUILD_TYPE)
    file(APPEND "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/absl_time.pc"
         "Libs.private: -framework CoreFoundation\n")
  endif()
endif()
...
if(VCPKG_TARGET_IS_WINDOWS AND VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
  ...
  vcpkg_replace_string(
    "${CURRENT_PACKAGES_DIR}/include/absl/base/internal/thread_identity.h"
    "defined(ABSL_CONSUME_DLL)" "1")
endif()
